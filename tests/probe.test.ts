...
it("recognizes legacy Xiaomi feature topology without guessing ATVV", () => {
  ...
  // RC003 has the same Feature IDs; its explicit ATVV service is decisive.
  expect(familyEvidence([...refs, attr({kind:1, uuid:"ab5e0001-5a21-4f05-bc7d-af01f617b664"})])).toBe(1);
});

...
Receiver firmware release binaries and their manifests/notices are authorized in receiver-firmware/. The firmware/ submodule points only to the separately audited public source repository. Never add private firmware sources, SDKs, recordings, credentials, or local configuration.

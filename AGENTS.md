...
Receiver firmware release binaries and their manifests/notices are authorized in receiver-firmware/. Never add private firmware sources, SDKs, recordings, credentials, or local configuration.
